...
<?php
    ...
    while ($row = mysqli_fetch_array($result1)) {
		...
		echo "<td><img class='e1' src='images/".$row['image']."' align='left' ></td>";
			...
			echo "<td><a href='edituser.php?id=$row[id]'  Onclick='return ConfirmEdit();'><i class='fa fa-edit'>&nbsp;</i></a> || "; 
			echo "<a href='deleteuser.php?id=$row[id]' Onclick='return ConfirmDelete();'><i class='fa fa-remove text-danger'>&nbsp;</i></a></td></tr>"; 
    }
	echo "</table>";
?>
</div>
