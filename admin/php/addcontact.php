...
if($conn)
{
        if(isset($_POST['addcontact']))
        {
            ...
            if($uploadOk ==1){
              ...
              $query= "insert into contact(name,mobile,amobile,email,dob,gender,address,state,pin,wapp,job,ano,image) 
              values('$name',$mobile,$amobile,'$email','$dob','$gender','$address','$state',$pin,$wapp,'$job',$ano,'$image');";
