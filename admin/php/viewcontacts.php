...
<?php
	 ...
	 echo "<table class='table table-striped table-bordered table-hover table-condensed bg-light' id='tblCustomers'>
				...
				<th>Gender</th><th>Address</th><th>State</th><th>PinCode</th><th>WhatsApp_No</th><th>Job</th><th>Adhar_No</th><th>Edit/Delete</th></tr>";
    ...
    while ($row = mysqli_fetch_array($result1)) {
		...
		echo "<td><img class='e1' src='images/".$row['image']."' align='left' ></td>";
			...
			echo "<td><a href='editcontact.php?id=$row[id]'><i class='fa fa-edit'>&nbsp;</i></a> || "; 
			echo "<a href='deletecontact.php?id=$row[id]'><i class='fa fa-remove text-danger'>&nbsp;</i></a></td></tr>"; 
    }
	echo "</table>";
?>
</div>
