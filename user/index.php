...
<h1 class="display-3 my-4">Contact With Each Other<br />Know Me</h1>
<a href="register.php" class="btn btn-brand" >Signup</a>
...
class="link-danger btn btn-brand" >Register</a></p>
</div>
</form>
</div>
<!-- Right -->
